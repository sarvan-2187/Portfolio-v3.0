      ...
      <div className="grid md:grid-cols-12 md:h-screen items-stretch sticky top-0">
        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full">
            ...
            >
              Welcome! <span className='wave'>👋</span><br></br>I&apos;m <span className='text-orange-500 animate-pulse'>Sarvan Kumar</span>.<br></br>A Frontend Engineer<br></br>with Expertise in HTML, CSS, JavaScript, React.JS, Next.JS, Tailwind, Figma, AdobeXD, Git, Framer, Webflow and Canva.</motion.h1>
