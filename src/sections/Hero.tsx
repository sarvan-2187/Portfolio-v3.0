      ...
      <div className="grid md:grid-cols-12 md:h-screen items-stretch sticky top-0">
        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full sm:h-screen">
            <div className="flex items-center justify-end mb-4 md:hidden lg:hidden">
...
>Welcome! <span className='wave'>👋</span><br></br>I&apos;m <span className='text-orange-800'>Sarvan Kumar</span></h1>
            <motion.h1
              ...
              animate={{ opacity: 1 }}
              ref={titleScope}
              className="text-4xl text-gray-400 md:text-6xl sm:max-w-[95%]  mt-4 md:mt-10  mb-4 lg:text-4xl md:w-[80%]"
            >
