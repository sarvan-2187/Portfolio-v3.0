        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full">
            <motion.h1
              ...
              animate={{ opacity: 1 }}
              ref={titleScope}
              className="text-5xl md:text-6xl sm:max-w-[95%]  mt-40 md:mt-0 lg:text-7xl md:w-[80%]"
            >
              Welcome!👋 I'm Sarvan Kumar. My Core TechStacks are HTML, CSS, JavaScript, React, Next.JS, Tailwind CSS, Framer-Motion.</motion.h1>
