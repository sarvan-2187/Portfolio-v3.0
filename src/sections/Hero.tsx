      ...
      <div className="grid md:grid-cols-12 md:h-screen items-stretch sticky top-0">
        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full">
            ...
            >
              Welcome! <span className='wave'>👋</span><br></br>I'm <span className='text-orange-500 animate-pulse'>Sarvan Kumar</span>.<br></br>A Frontend Engineer.<br></br>My Core Technologies<br></br>include HTML, CSS, JavaScript, React, Next.JS, Tailwind CSS, Git, Vite, Framer & Design tools - Framer, Figma</motion.h1>
